          ...
          <List>
            {links.map((l) => (
              <ListItem key={l.to} disablePadding>
                <ListItemButton component={NavLink} to={l.to} onClick={() => setMobileOpen(false)}>
...
{/* {searchOpen && (
  ...
  className="relative z-50 w-full max-w-xl px-4"
  role="search"
  ...
  placeholder="Search..."
  />
        <button type="submit" className="text-sm font-medium px-3 py-1">
          Search
        </button>
        <button
        type="button"
