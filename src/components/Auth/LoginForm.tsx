...
export default function LoginForm() {
  ...
  return (
    ...
    >
      ...
      {/* //link by default is an inline element it is anchor tag //will make it
      block to align text */}
      {/* the div shrinked to the width of the link so had to do w-full to take the full width. */}
      <div className="w-full mt-[5px] flex justify-end">
        <Link
          to="/forget-password"
          className="text[#373737] font-semibold text-[18px] leading-[100%] tracking-normal"
        >
          Forget Password?
        </Link>
      </div>
      ...
      <div className="text-[#111928] font-semibold text-[18px] leading-[100%] tracking-normal">
        ...
        <Link
          className="text-[#1E429F] font-semibold text-[18px] 
