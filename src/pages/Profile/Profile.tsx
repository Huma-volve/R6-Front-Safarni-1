    ...
    <>
      <div className="container w-full sm:w-[90%] lg:w-[80%] mx-auto mt-6 px-4 md:px-0">
        ...
        <div className="info mx-auto mt-6 rounded-lg border border-gray-600 overflow-hidden">
          <div
            onClick={() => click("Personal Information")}
            className="wrappe flex items-center justify-between p-4 cursor-pointer hover:bg-gray-50 hover:scale-[1.02] transition-all duration-200 ease-in-out"
          >
          ...
          <div
            onClick={() => click("Account & Security")}
            className="wrappe flex items-center justify-between p-4 cursor-pointer hover:bg-gray-50 hover:scale-[1.02] transition-all duration-200 ease-in-out"
          >
            <div className="flex items-center gap-2">
